...
const CATEGORIES = [
  ...
  ["Food", "food", "Restaurants, recipes, and food finds"],
  ["Groceries", "groceries", "Everyday essentials"],
  ["Videos", "videos", "YouTube and short-form video"],
  ["Deals", "deals", "Discounts and limited offers"],
  ["Fashion", "fashion", "Style and apparel"],
  ["Technology", "technology", "Gadgets and tech"],
  ["Gaming", "gaming", "Games and gear"],
  ["Education", "education", "Courses and learning"],
  ["Travel", "travel", "Places and experiences"],
  ["Beauty", "beauty", "Skincare and beauty"],
  ["Services", "services", "Professional services"],
  ["Startups", "startups", "Early-stage products"],
  ["Apps", "apps", "Mobile and web apps"],
  ["Creators", "creators", "Creator profiles and content"],
  ["Local Businesses", "local-businesses", "Nearby businesses"],
];
...
async function main() {
  ...
  const admin = await prisma.user.create({
    data: {
      email: "admin@makemeviral.app",
      passwordHash,
      name: "Platform Admin",
      role: Role.SUPER_ADMIN,
      profile: { create: { username: "admin", displayName: "MakeMeViral Admin", isVerified: true } },
